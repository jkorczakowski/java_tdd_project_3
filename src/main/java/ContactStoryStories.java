...
public class ContactStoryStories extends JUnitStories {
    public ContactStoryStories() {
    ...
    public InjectableStepsFactory stepsFactory() {
        return new InstanceStepsFactory(configuration(), new ContactSteps(), new SearchDressSteps(),
                new AddDressToCartSteps(), new BuyMoreDressesSteps(), new LogInSteps());
    }
